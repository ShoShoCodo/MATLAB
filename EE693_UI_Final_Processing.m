...
title('ECG Data')
xlabel('Time (s)')
ylabel('3.3V/1024 scaling factor')
saveas(E,[pathName,'\figures',num2str(k),'\','ECG',ShortEndName],'fig')
...
xlabel('Time (s)')
ylabel('3.3V/1024 scaling factor')
saveas(M,[pathName,'\figures',num2str(k),'\','EMG',ShortEndName],'fig')
...
title('ECG Data')
xlabel('Time (s)')
saveas(A,[pathName,'\figures',num2str(k),'\','ALL Axis Motion ECG ',ShortEndName],'fig')
...
title('ECG Data')
xlabel('Time (s)')
saveas(A2,[pathName,'\figures',num2str(k),'\','Motion ECG ',ShortEndName],'fig')
...
xlabel('Time (s)')
ylabel('%')
saveas(s,[pathName,'\figures',num2str(k),'\','SP02',ShortEndName],'fig')
close all;
...
%%%******** using flags for HR detection
HR = rpeak_Shoa(ecgData,flagData,k,pathName,ShortEndName); % give the HR for that 45 sample period
...
% xlabel('ecg_FFT')
% saveas(OF,[pathName,'figures',num2str(k-1),'\','Original FFTs',ShortEndName],'fig')
% 
% 
% 
% N  = 2;     % Order
...
% xlabel('ecg_FFT')
% saveas(F,[pathName,'\figures',num2str(k-1),'\','Filtered FFT',ShortEndName],'fig')
% 
% 
% 
% P=figure('Name', ['Post Filtering Comparison'])
% subplot(2,1,1), plot(t,ecgData)
% title(['ECG Data', ShortEndName])
% xlabel('Time (s)')
% subplot(2,1,2), plot(t,Filtered_ECG)
% title(['ECG Data Post Processed ',ShortEndName])
% xlabel('Time (s)')
% saveas(P,[pathName,'\figures',num2str(k-1),'\','Post Filtering Comparison',ShortEndName],'fig')
